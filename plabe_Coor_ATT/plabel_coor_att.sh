...
CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Art --tgt_domain Clipart --is_balance 'False'
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Clipart --tgt_domain Real_World --is_balance 'False'
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Art --tgt_domain Real_World --is_balance 'False'
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Product --tgt_domain Real_World --is_balance 'False'
# # Office-Home
...
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Art --tgt_domain Real_World | tee ./plabe_Coor_ATT/plabelcoor06_A2R_bal.txt
...
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Clipart --tgt_domain Real_World | tee ./plabe_Coor_ATT/plabelcoor06_C2R_bal.txt
...
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Product --tgt_domain Real_World | tee ./plabe_Coor_ATT/plabelcoor06_P2R_bal.txt
#CUDA_VISIBLE_DEVICES=$GPU_ID python plabe_coor_att.py --config plabe_Coor_ATT/plabel_coor_att.yaml --data_dir $data_dir --src_domain Product --tgt_domain Clipart | tee ./plabe_Coor_ATT/plabelcoor06_P2C_bal.txt
